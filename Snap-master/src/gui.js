...
//    button.pressColor = colors[2];
    ...
    button.labelShadowOffset = new Point(-1, -1);
    button.labelShadowColor = colors[1];
    button.labelColor = new Color(0, 0, 0);
    button.contrast = this.buttonContrast;
    button.drawNew();
    // button.hint = 'start green\nflag scripts';
    button.fixLayout();
    verifyButton = button;
    this.controlBar.add(verifyButton);
    this.controlBar.verifyButton = verifyButton;
    ...
    this.controlBar.fixLayout = function () {
        ...
        [stopButton, pauseButton, startButton, verifyButton].forEach(
            function (button) {
...
IDE_Morph.prototype.pressVerify = function () {
       var dataa = this.runVerifyScripts();
       this.download(dataa, 'Verification.txt', 'text/plain');
};

IDE_Morph.prototype.download = function(data, filename, type) {
...
IDE_Morph.prototype.runVerifyScripts = function() {
    return this.stage.fireVerifyEvent();
}
